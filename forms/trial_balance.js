...
/*        if ( out_classes.length <= 2 )  {
            if ( !classes[1] )  {
                this.line_out(`【${out_classes[1]}】`, null, null, null, null);
            }
            this.line_out(`  ${out_classes[1]}合計`,
                    pickup.sum(1), debit.sum(1), credit.sum(1), balance.sum(1));
        }
*/        if  ( out_classes.length <= 1 )  {
